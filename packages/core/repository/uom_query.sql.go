...
INSERT INTO product_uom_conversions (
    ...
    $1, $2, $3, $4, $5, $6
) RETURNING id, product_id, from_uom_id, to_uom_id, conversion_factor, is_default, metadata, created_at, updated_at
`
...
INSERT INTO units_of_measure (
    ...
    $1, $2, $3, $4, $5, $6
) RETURNING id, code, name, uom_type, decimal_places, is_active, metadata, created_at, updated_at
`
...
SELECT id, product_id, from_uom_id, to_uom_id, conversion_factor, is_default, metadata, created_at, updated_at FROM product_uom_conversions
...
SELECT id, code, name, uom_type, decimal_places, is_active, metadata, created_at, updated_at FROM units_of_measure
WHERE id = $1
`
