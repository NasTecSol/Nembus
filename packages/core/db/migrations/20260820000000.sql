-- Migration: Product enrichment review queue (Stage 1)
-- Persistence and domain infrastructure only; no provider calls or product mutation.

CREATE TABLE IF NOT EXISTS product_enrichment_suggestions (
...
CREATE INDEX IF NOT EXISTS idx_product_enrichment_suggestions_organization_status
