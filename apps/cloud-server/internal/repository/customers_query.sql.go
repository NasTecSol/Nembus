...
WHERE id = $1
RETURNING id, organization_id, customer_code, name, email, phone, address, customer_type, price_list_id, credit_limit, outstanding_balance, loyalty_points, loyalty_tier, is_active, metadata, created_at, updated_at
`
...
SELECT id, organization_id, customer_code, name, email, phone, address, customer_type, price_list_id, credit_limit, outstanding_balance, loyalty_points, loyalty_tier, is_active, metadata, created_at, updated_at FROM customers
WHERE id = $1
`
